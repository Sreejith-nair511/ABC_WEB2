...
export default function JoinUs() {
  return (
    <div className="relative mx-auto max-w-3xl rounded-2xl border border-[#00FF9C33] bg-white/5 p-8 text-center backdrop-blur shadow-[0_0_60px_-12px_rgba(0,255,156,0.35)]">
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link href="https://forms.gle/EhvAyKhG4L5mvyCZ7" target="_blank">
